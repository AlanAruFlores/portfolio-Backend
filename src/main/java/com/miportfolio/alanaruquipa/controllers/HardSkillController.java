...
public class HardSkillController {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<HardSkill>> getAll(){
    ...
    @PostMapping("/post")
    public ResponseEntity<?> saveSkill(@RequestBody HardSkill skill){
    ...
    @PostMapping("/update")
    public ResponseEntity<?> updateSkill(@RequestParam("id") int id, @RequestBody HardSkill skill){
        if(!this.service.existsById(id))
